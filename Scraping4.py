...
for info in data:
    ...
    price = float(info.select_one("td:nth-of-type(2)").text.replace(',' , '')) * 0.00075
    open = float(info.select_one("td:nth-of-type(3)").text.replace(',' , '')) * 0.00075
    high = float(info.select_one("td:nth-of-type(4)").text.replace(',' , '')) * 0.00075
    low = float(info.select_one("td:nth-of-type(5)").text.replace(',' , '')) * 0.00075
...
table.to_csv('C:\\Users\\Rakon\\Desktop\\Midterm Project\\Samsung.csv')